...
const navigation = [
  { name: 'หน้าแรก', href: './Home_Teachers', current: false },
  { name: 'จัดการข้อมูลประชาสัมพันธ์', href: './PublicRelationsManagement_Teacher', current: false },
];
                  ...
                  <div>
                    <Menu.Button className="flex rounded-full bg-cyan-100 text-sm focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:ring-offset-2 focus:ring-offset-cyan-600">
                      ...
                      <img
                        ...
                        src={userImg} // แสดงรูปโปรไฟล์จาก Firestore หรือ favicon.ico
                        alt="User"
                      />
                    </Menu.Button>
                  </div>
