                            ...
                            <div className='grid grid-cols-2'>
                                ...
                                <Card className=' bg-orange-100 my-4 col-span-2 xl:col-span-1'>
                                    <div className='grid grid-cols-5'>
                                        ...
                                        <Radio.Group onChange={onChange9} value={value8} className=' col-span-4 '>
                            ...
                            <div className='grid grid-cols-2'>
                                ...
                                <Card className=' bg-orange-100 col-span-2 xl:col-span-1'>
                                    <div className='grid grid-cols-6'>
                                        ...
                                        <Input value={total} aria-labelledby='2' className=' text-center w-full my-2 text-red-800 text-base border-b-2 border-yellow-300 pt-0 pb-0 rounded-xl col-span-2 -ml-5'>
                                        </Input>
                                        <p className=' text-start w-full my-2 text-red-800 text-base  pb-3 col-span-1' >
                                            โต๊ะ
                                        </p>
                                        ...
                                        <Input onChange={handleChange3} id='1' type='Number' className=' text-center w-full my-2 text-red-800 text-base border-b-2 border-yellow-300 pt-0 pb-0 rounded-xl col-span-2 -ml-5'>
                                        </Input>
                                        <p className=' text-start w-full my-2 text-red-800 text-base  pb-3 col-span-1' >
                                            คน
                                        </p>
                                        ...
                                        <Input value={total1} aria-labelledby='1' className=' text-center w-full my-2 text-red-800 text-base border-b-2 border-yellow-300 pt-0 pb-0 rounded-xl col-span-2 -ml-5'>
                                        </Input>
                                        <p className=' text-start w-full my-2 text-red-800 text-base  pb-3 col-span-1' >
                                            บาท
                                        </p>
