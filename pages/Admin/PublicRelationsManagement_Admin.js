...
import { Button, Input, Space, Table, Modal, Form, Switch, Card } from 'antd';
...
export default function PublicRelationsManagement() {
    ...
    const columns = [
        ...
        },
        {
            ...
            dataIndex: 'status',
            key: 'status',
            render: (status) => <Switch checked={status} loading defaultChecked />,
        },
        {
            title: 'แก้ไข',
            width: '10%',
    ...
    return (
        <>
            ...
            <Modal width={'90%'} title="รายละเอียดข้อมูลประชาสัมพันธ์" open={isViewModalVisible} onCancel={() => setIsViewModalVisible(false)} footer={null}>
                {selectedItem && (
                    <div className="flex min-h-full items-center justify-center mt-6 sm:px-6 lg:px-8">
                        <Card style={{ width: '90%' }}>
                            <Form layout="inline">
                                <div className="w-full sm:w-full mt-2">
                                    <label className=' font-extrabold'>รูปข้อมูลประชาสัมพันธ์</label>
                                ...
                                <div className="w-full mt-2">
                                    <label className=' font-bold '>ชื่อข้อมูลประชาสัมพันธ์</label>
                                    <p>&nbsp;&nbsp;&nbsp;{selectedItem.EventName}</p>
                                </div>

                                <div className="w-full mt-2">
                                    <label className=' font-bold '>รายละเอียดข้อมูลประชาสัมพันธ์</label>
                                    <p>&nbsp;&nbsp;&nbsp;{selectedItem.EventDetail}</p>
                                </div>

                                <div className="w-full mt-2">
                                    <label className=' font-bold '>รายละเอียดเพิ่มเติมข้อมูลประชาสัมพันธ์</label>
                                    <p>&nbsp;&nbsp;&nbsp;{selectedItem.EventMore}</p>
                                </div>
                                ...
                                <div className="w-full mt-2">
                                    <label className=' font-bold '>วันที่โพสต์</label>
