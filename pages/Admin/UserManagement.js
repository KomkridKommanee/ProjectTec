...
export default function UserManagement() {
    ...
    const deleteRecord = async (record) => {
        try {
            await deleteDoc(doc(db, 'user', record.id)); // ใช้ record.id แทน record.key
    ...
    return (
        <>
            ...
            <div className=' justify-self-center py-5 md:py-7 shadow-xl'>
                <p className=' text-3xl md:text-2xl text-start pl-44 font-bold'>จัดการข้อมูลผู้ใช้งาน</p>
            </div>
